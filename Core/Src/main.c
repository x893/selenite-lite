...
static void MX_GPIO_Init (void)
{
  ...
  HAL_GPIO_WritePin (
      GPIOB,
      ILI9341_DC_Pin | ILI9341_CS_Pin | ILI9341_RES_Pin | I2S2_RES_Pin | TX_Pin,
      GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : ILI9341_DC_Pin ILI9341_CS_Pin ILI9341_RES_Pin ILI9341_LED_Pin
   I2S2_RES_Pin TX_Pin */
  GPIO_InitStruct.Pin = ILI9341_DC_Pin | ILI9341_CS_Pin | ILI9341_RES_Pin
      | ILI9341_LED_Pin | I2S2_RES_Pin | TX_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
